...
interface TeresinaMapBottomSheetProps {
  visit: TeresinaVisit | null;
  onClose: () => void;
}

export default function TeresinaMapBottomSheet({ visit, onClose }: TeresinaMapBottomSheetProps) {
        ...
        <>
          ...
          >
            ...
            <div className="min-h-0 flex-1 overflow-hidden">
              <TeresinaMapDetailPanel visit={visit} onClose={onClose} compact />
            </div>
          </motion.div>
        </>
      )}
